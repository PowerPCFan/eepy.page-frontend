...
<Holder>
    ...
    <p>
        This privacy notice for frii.site ('<strong>we</strong>', '<strong>us</strong>', or '<strong
            >our</strong
        >' ), describes how and why we might collect, store, use, and/or share ('<strong
            >process</strong
    ...
    <ul>
        <li>
            Visit our website at <a href="http://www.frii.site">http://www.frii.site</a> , or any website
    ...
    <p>
        <strong
            ...
            using our
        </strong> <a href="#toc"><strong>table of contents</strong></a>
    ...
    <p>
        ...
        by visiting
        <a href="http://www.frii.site/account/manage">http://www.frii.site/account/manage</a> , or by
    ...
    <p>
        <strong>In Short:</strong> <strong> </strong>We collect personal information that you
        provide to us.
    </p>
    <p>
    ...
    <p>
        <strong>In Short:</strong> <strong> </strong> Some information - such as your Internet Protocol
    ...
    <ul>
        <li>
            <strong
                ...
                accounts.
            </strong>We may process your information so you can create and log in to your account,
    ...
    <p>
        ...
        your permission can be inferred (i.e. implied consent). You can <a href="#withdrawconsent"
    ...
    <p>
        ...
        <strong>third parties</strong>') who perform services for us or on our behalf and require
        ...
        it. They will also not share your personal information with any organisation apart from us.
        They also commit to protect the data they hold on our behalf and to retain it for the period
        we instruct. The categories of third parties we may share personal information with are as
        follows:
    </p>
    <ul>
    ...
    <ul>
        <li>
            <strong>When we use Google Analytics.</strong> We may share your information with Google
            Analytics to track and analyse the use of the Services. The Google Analytics Advertising
            Features that we may use include: Google Analytics Demographics and Interests Reporting
            and Google Display Network Impressions Reporting . To opt out of being tracked by Google
    ...
    <p>
        <strong>In Short:</strong> We are not responsible for the safety of any information that you
        share with third parties that we may link to or who advertise on our Services, but are not affiliated
        with, our Services.
    </p>
    <p>
        ...
        caused by the use of such third-party websites, services, or applications. The inclusion of
        a link towards a third-party website, service, or application does not imply an endorsement
        by us. We cannot guarantee the safety and privacy of data you provide to any third parties.
        Any data collected by third parties is not covered by this privacy notice. We are not
        responsible for the content or privacy and security practices and policies of any third
        parties, including other websites, services, or applications that may be linked to or from
        the Services. You should review the policies of such third parties and contact them directly
    ...
    <p>
        ...
        please contact us at contact@frii.site .
    </p>
    ...
    <p>
        ...
        Kingdom (UK), Switzerland, and Canada, you have rights that allow you greater access to and control
    ...
    <p>
        ...
        personal information, you also have the right to complain to your <a
    ...
    <p>
        ...
        <a href="http://www.aboutads.info/choices/"
            >opt out of interest-based advertising by advertisers</a> on our Services.
    </p>
    <p>
    ...
    <p>
        <strong>In Short: </strong> If you are a resident of California , you are granted specific rights
    ...
    <p>
        ...
        commercial purpose can be found under ' <a href="#whoshare"
            >WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a> '
    </p>
    ...
    <ul>
        <li>
            You may request to opt out from future selling or sharing of your personal information
            to third parties. Upon receiving an opt-out request, we will act upon the request as
    ...
    <p>
        To exercise these rights, you can contact us by visiting <a
            href="http://www.frii.site/account/manage">http://www.frii.site/account/manage</a> , by email
        at contact@frii.site , or by referring to the contact details at the bottom of this document.
    ...
    <p>
        If you have questions or comments about this notice, you may email us at contact@frii.site
