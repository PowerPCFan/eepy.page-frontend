    ...
    <ul>
        <li>
            <p>
                ...
                of the shares, equity interest or other securities entitled to vote for election of directors
        ...
        <li>
            <p>
                ...
                &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to frii.site.
            </p>
        </li>
        <li>
            <p>
        ...
        <li>
            <p>
                <strong>Website</strong> refers to frii.site, accessible from
                <a href="https://frii.site" rel="external nofollow noopener" target="_blank"
                    >https://frii.site</a>
            </p>
        </li>
        <li>
